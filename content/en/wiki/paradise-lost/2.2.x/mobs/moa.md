...
To see a full list of Moa spawn colors and breeding percentages, check out the **[Moa Breeding Guide](/wiki/paradise-lost/2.2.x/guides/moa-breeding/)**.
...
### Moa Stats
Each Moa has six associated stats that can be checked with an **[Surtrum Bloodstone](/wiki/paradise-lost/2.2.x/items/bloodstone/)**:
...
### Breeding
Moas are tempted and bred with **Oranges** harvested from Orange trees. The offspring will have an equal chance of inheriting the pattern of each parent unless a special breeding result exists. Consult the **[Moa Breeding Guide](/wiki/paradise-lost/2.2.x/guides/moa-breeding/)**. Children will inherit improved stats from their parent meaning that the children will have **equal or better stats**.

Breeding Moas does not immediately spawn the child, instead dropping a Moa Egg that must be incubated in either an **Incubator** or **Moa Nest** block. Incubation is affected by multiple factors, which you can read about in the **[Incubation Guide](/wiki/paradise-lost/2.2.x/guides/incubation/)**.


## Spawn Locations
Moas can be found in the following biomes:
* [Autumnal Tundra](/wiki/paradise-lost/2.2.x/biomes/autumnal-tundra/) (common)
* [Continental Plateau](/wiki/paradise-lost/2.2.x/biomes/continental-plateau/) (common)
* [Highlands](/wiki/paradise-lost/2.2.x/biomes/highlands/) (common)
* [Highlands Forest](/wiki/paradise-lost/2.2.x/biomes/highlands-forest/) (common)
* [Highlands Grand Glade](/wiki/paradise-lost/2.2.x/biomes/highlands-thicket/) (common)
* [Wisteria Woods](/wiki/paradise-lost/2.2.x/biomes/wisteria-woods/) (common)
* [Highlands Shield](/wiki/paradise-lost/2.2.x/biomes/highlands-shield/) (uncommon)
* [Highlands Thicket](/wiki/paradise-lost/2.2.x/biomes/highlands-thicket/) (uncommon)
